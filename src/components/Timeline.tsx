...
export default function Timeline() {
  return (
    <section className="relative w-full overflow-hidden py-24 bg-gradient-to-br from-yellow-50 via-pink-50 to-white">
      {/* ♥ center shimmer line */}
      <motion.div
      ...
      >
        ...
        {/* second pass (mirrored → endless strip) */}
        {timelineData.map((m, i) => (
